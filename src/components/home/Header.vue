<template>
  <div>
    ...
    <el-row class="nav-menu">
      <el-col :span="6">
        <div class="grid-content text-mute logo">
          <img class="logoimg" src="./../../../static/image/logotwo.png" alt>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="grid-content text-mute menu-father">
          <el-menu default-active="1" class="el-menu-demo delBorder" mode="horizontal">
            ...
            <el-menu-item index="4" class="menu" @click="goAbout">关于我们</el-menu-item>
